...
const MobileNav: React.FC<MobileNavProps> = ({showMobileMenu, setShowMobileMenu, products, templates, setShowProducts, showProducts, setShowTemplates, showTemplates}) => {
        ...
        <div className='flex justify-between items-center mb-10'>
          ...
          <ul className=''>
            <li 
              ...
              <ProductsDropdown showProducts={showProducts} products={products}  from='mobile' />
            <hr className='text-gray-300 my-5' />

            <li className='flex justify-between items-center text-[#4C4D5F] cursor-pointer'
            onClick={() => setShowTemplates(!showTemplates)}>
                <span className='mr-2'>Templates</span>
                <i className='bx bx-chevron-down' style={{'color':'#565252'}}  ></i>
            </li>
              <TemplatesDropdown templates={templates} showTemplates={showTemplates}  from='mobile' />
            <hr className='text-gray-300 my-5' />
            ...
            <button className='border block mb-5 w-full border-[#00b289] text-[#00b289] cursor-pointer hover:bg-[#00b289] hover:text-white text-xs font-bold px-6 py-3 rounded'>LOG IN</button>
            <button className='text-xs block font-bold w-full text-white bg-[#00b289] cursor-pointer hover:bg-[#7bc9b7] py-3 px-10 rounded'>START FREE</button>
          </ul>
