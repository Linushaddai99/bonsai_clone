...
const Navbar = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      title: "Bonsai Cash",
      description:
        "Bonsais all-in-one cash hub: No fees and lightining fast payouts",
    },
  ];
  ...
  const templates = [
    {
      ...
      features: [
        "Free contract maker",
        "Social media manangement contract Template",
    ...
    },
    {
      ...
      features: [
        "Web Design Quotation Templates",
    ...
    },
    {
      ...
      features: [
        ...
        "Video Production Scope of Work Template",
      ],
      icon: "schedule",
    },
    {
    ...
    <div className=" bg-white sticky top-0 z-50 w-full">
      <div className="md:w-[80%] w-[90%] mx-auto py-5 flex justify-between items-center">
        ...
        <div className="lg:flex md:justify-between md:w-[70%] hidden items-center">
          ...
          <div className="">
            <button className="border border-[#00b289] text-[#00b289] cursor-pointer hover:bg-[#00b289] hover:text-white text-xs font-bold px-6 py-3 rounded">
              LOG IN
            </button>
            <button className="text-xs font-bold text-white bg-[#00b289] cursor-pointer hover:bg-[#7bc9b7] ml-6 py-3 px-10 rounded">
              START FREE
            </button>
          </div>
        </div>
